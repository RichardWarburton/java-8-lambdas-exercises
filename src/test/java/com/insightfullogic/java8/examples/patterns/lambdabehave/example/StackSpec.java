package com.insightfullogic.java8.examples.patterns.lambdabehave.example;

import java.util.Stack;

import static com.insightfullogic.java8.examples.patterns.lambdabehave.Lets.describe;
